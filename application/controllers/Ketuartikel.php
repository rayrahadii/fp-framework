...
class Ketuartikel extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('template', 'artikel/ketua_data', $data);
	}
	...
	public function detail($id)
	{
		...
		if($query->num_rows() > 0) {
			...
			$this->template->load('template', 'artikel/ketua_detail', $data);
		}
	}
}