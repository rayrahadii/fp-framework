...
class Mahasiswa extends CI_Controller {
	...
	{
		$data['row'] = $this->artikel_m->getArtikel3();
		$this->template->load('template', 'artikel/mahasiswa_data', $data);
	}
	...
	public function add() 
	{
		...
		$this->template->load('template', 'artikel/mahasiswa_form', $data);
	}
	...
	public function detail($id)
	{
		...
		if($query->num_rows() > 0) {
			...
			$this->template->load('template', 'artikel/mahasiswa_detail', $data);
		}
	}
}