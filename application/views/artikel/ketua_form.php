            ...
            <div class="box-body">
              <form enctype="multipart/form-data" action="<?=site_url('ketuartikel/process')?>" method="post">
                <div class="form-group">
                 ...
                 <input type="text" name="isi_artikel" class="form-control" placeholder="Keterangan Artikel Disini" required><?=$row->isi_artikel?></textarea>
                </div>
                <div class="form-group">
                  <label>Isi Artikel</label>
                 <textarea type="text" name="isi_artikel" rows="8" class="form-control" placeholder="isi Artikel Disini" required><?=$row->isi_artikel?></textarea>
                </div>
