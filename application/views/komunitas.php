...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('<?=base_url()?>frontend/images/marching.jpg');">
        <div class="container">
      ...
      <div class="intro-section" style="background-image: url('<?=base_url()?>frontend/images/renang.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1 class="display-2">KOLU</h1>
      ...
      <div class="intro-section" style="background-image: url('<?=base_url()?>frontend/images/mahapala.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
            <h1 class="display-2">UMMI</h1>
          <h3>Unit Kegiatan Mahasiswa</h3>
          <a href="<?=site_url('home/register')?>"><button type="button" class="btn btn-outline-light btn-lg">Daftar Sekarang</button></a>
            </div>
          </div>
      ...
      <div class="intro-section" style="background-image: url('<?=base_url()?>frontend/images/pramuka.jpeg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
            <h1 class="display-2">PRAMUKA</h1>
          <h3>Unit Kegiatan Mahasiswa</h3>
          <a href="<?=site_url('home/register')?>"><button type="button" class="btn btn-outline-light btn-lg">Daftar Sekarang</button></a>
            </div>
          </div>
